...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "nav.tasks": "任务管理",
    "nav.taskManagement": "任务列表",
    "nav.epicManagement": "大任务管理",
    "nav.epicList": "大任务列表",
    "nav.epicListLoading": "加载中...",
    "nav.epicListEmpty": "暂无大任务",
    "nav.epicListError": "读取失败",
    "nav.epicSubtasks": "子任务",
    "nav.epicDependencies": "任务依赖",
    "nav.epicNoDependencies": "无依赖",
    "nav.unassigned": "未分配",
    "nav.missing": "不存在",
    "nav.meetings": "会议记录",
    "nav.meetingSettings": "会议设置",
    "nav.config": "配置",
    ...
    "sessions.confirmDelete": "确定要删除这个会话吗？",
    "sessions.sessionFull": "会话已满",
    "sessions.sessionFullHint": "上下文窗口已使用超过90%，建议删除会话",
    ...
    // pixel office
    "pixelOffice.title": "Landasika牛马们的办公室",
  ...
  en: {
    ...
    "nav.tasks": "Tasks",
    "nav.taskManagement": "Task List",
    "nav.epicManagement": "Big Task Management",
    "nav.epicList": "Big Task List",
    "nav.epicListLoading": "Loading...",
    "nav.epicListEmpty": "No big tasks",
    "nav.epicListError": "Load failed",
    "nav.epicSubtasks": "Subtasks",
    "nav.epicDependencies": "Dependencies",
    "nav.epicNoDependencies": "No dependencies",
    "nav.unassigned": "Unassigned",
    "nav.missing": "Missing",
    "nav.meetings": "Meetings",
    "nav.meetingSettings": "Meeting Settings",
    ...
    "sessions.sessionFull": "Session Full",
    "sessions.sessionFullHint": "Context window usage exceeds 90%, consider deleting session",
