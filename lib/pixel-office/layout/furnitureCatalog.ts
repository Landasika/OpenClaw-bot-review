...
import {
  ...
  TS_BOSS_CHAIR, TS_BOSS_DESK, TS_BOSS_MONITOR,
...
export const FURNITURE_CATALOG: CatalogEntryWithCategory[] = [
  ...
  // ── Boss exclusive custom sprites ──
  { type: FurnitureType.BOSS_CHAIR,   label: 'Boss Chair',   footprintW: 1, footprintH: 1, sprite: TS_BOSS_CHAIR,   isDesk: false, category: 'chairs' },
  { type: FurnitureType.BOSS_DESK,    label: 'Boss Desk',    footprintW: 2, footprintH: 2, sprite: TS_BOSS_DESK,    isDesk: true,  category: 'desks'  },
  { type: FurnitureType.BOSS_MONITOR, label: 'Boss Monitor', footprintW: 1, footprintH: 1, sprite: TS_BOSS_MONITOR, isDesk: false, category: 'electronics', canPlaceOnSurfaces: true },
]
